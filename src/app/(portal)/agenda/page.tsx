...
export default function AgendaWithTrackGrid() {
  return (
    <p>
      Live agenda :{' '}
      <a href="https://docs.google.com/spreadsheets/d/1I6NWd3vTgxMTUID7BllVu4PEWJ-_HpcBKz2wkpoofqY/edit?usp=drivesdk" target="_blank" rel="noopener noreferrer">
        Google Sheet
      </a>
    </p>
  );
