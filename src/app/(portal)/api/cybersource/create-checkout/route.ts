...
export async function POST(req: Request) {
    ...
    const fields: Record<string,string> = {
        ...
        signed_field_names: 'access_key,profile_id,transaction_uuid,transaction_type,reference_number,amount,currency,locale,success_url,cancel_url,merchant_post_url',
