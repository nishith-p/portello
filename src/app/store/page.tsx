...
import { ProductCard, ProductModal } from '@/app/store/(components)';
import { PackCard } from '@/app/store/(components)/pack-card';
import { PackModal } from '@/app/store/(components)/pack-modal';
